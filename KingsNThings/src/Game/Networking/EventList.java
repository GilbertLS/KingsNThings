...
public class EventList {
	...
	public static final int CLEAR_THINGS = 211;
	public static final int SETTING_PHASE = 212;
	public static final int GET_DEFENDER = 213;
	public static final int ADD_THING_TO_RACK = 214;
